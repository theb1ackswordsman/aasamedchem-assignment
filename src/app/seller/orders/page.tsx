...
export default function SellerOrdersPage() {
  ...
  return (
    <div className="space-y-8 bg-white text-left">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-[22px] font-medium text-gray-900">My Orders</h1>
        </div>
        <Button
          onClick={fetchOrders}
          variant="outline"
              ...
              {ordersList.map((order, idx) => {
                ...
                return (
                  <React.Fragment key={order.id}>
                    <TableRow 
                      className={`h-11 border-b border-gray-100 last:border-0 hover:bg-gray-50/50 cursor-pointer ${
